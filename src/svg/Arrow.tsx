...
export default function ArrowIcon({ className, size=13 }: ArrowIconProps) {
    return (
      <svg width={size} height={size} viewBox="0 0 13 12" className={className} xmlns="http://www.w3.org/2000/svg">
      <g clipPath="url(#clip0_6511_1075)">
